...
- (void) resetWebView {
    //removes the old view from the hierarchy
    [self.webView removeFromSuperview];
    
    //create new empty field and add it back
...
//buttons will point to old webview have to remove that reference and tell them we've switched webviews
